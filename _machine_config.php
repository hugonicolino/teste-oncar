...
GlobalConfig::$CONNECTION_SETTING->DBName = "oncar";
...
/** the root url of the application with trailing slash, for example http://localhost/oncar/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'oncar/';
