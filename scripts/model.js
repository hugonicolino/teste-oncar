/**
 * backbone model definitions for ONCAR
 */
...
/**
 * Estoque Backbone Model
 */
model.EstoqueModel = Backbone.Model.extend({
	urlRoot: 'api/estoque',
	idAttribute: 'veiculo',
	veiculo: '',
	marca: '',
...
/**
 * Estoque Backbone Collection
 */
model.EstoqueCollection = model.AbstractCollection.extend({
	url: 'api/estoques',
	model: model.EstoqueModel
});
