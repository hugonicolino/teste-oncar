...
require_once("DAO/EstoqueCriteriaDAO.php");

/**
 * The EstoqueCriteria class extends EstoqueDAOCriteria and is used
 ...
 * @version 1.0
 */
class EstoqueCriteria extends EstoqueCriteriaDAO
{
